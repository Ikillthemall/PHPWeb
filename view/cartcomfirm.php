...
<div class="container">
    <div class="grid width">
                    ...
                    <div class="l-12 m-4 c-4 col__loginleft">
                        <div class="login__form">
                            ...
                            <div class="login__mainForm">
                                ...
                                <ul>
                                    <li class="login__title">- Mã đơn hàng: LT-<?=$oneBill['idBill']?></li>
                                    <li class="login__title">- Ngày đặt hàng: <?=$oneBill['billDate']?></li>
                                    <li class="login__title">- Tổng đơn hàng: <?=$oneBill['billTotal']?> VNĐ</li>
                                    <li class="login__title">- Phương thức thanh toán: <?=$oneBill['billPay']?></li>
                                </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="login__mainForm">
                                ...
                                <div class="login__mainForm-action">                             
                                    ...
                                    <div class="login__mainForm-action-group">
                                        ...
                                        <input value="<?=$oneBill['billName']?>" name="username" type="text" class="login__mainForm-action-group-input">
                                    </div>
                                    <div class="login__mainForm-action-group">
                                        <label for="#">Địa chỉ</label>
                                        <input value="<?=$oneBill['billAddress']?>" name="address" type="text" class="login__mainForm-action-group-input">
                                    </div>
                                    <div class="login__mainForm-action-group">
                                        <label for="#">Email người đặt</label>
                                        <input value="<?=$oneBill['billEmail']?>" name="email" type="email" class="login__mainForm-action-group-input">
                                    </div>
                                    <div class="login__mainForm-action-group">
                                        <label for="#">Số điện thoại</label>
                                        <input value="<?=$oneBill['billPhone']?>" name="phone" type="tel" class="login__mainForm-action-group-input">
                                    </div>
                                </div>
                                </div>
                            </div>
                ...
                <div class="content__body-heading">
                    ...
                    <span style="font-size: 2rem; color:#333; font-weight: 500;">CHI TIẾT GIỎ HÀNG</span>
                </div>
