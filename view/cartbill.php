...
<div class="container">
            <div class="grid width">
                <!-- viewinfor -->
            <form action="index.php?view=cartcomfirm" method="post">
                <div class="content row">
                    <div class="l-12 m-4 c-4 col__loginleft">
                        <?php
                        ...
                        <div class="login__form">
                            <h2 class="login__title">Thông tin đặt hàng</h2>
                            <div class="login__mainForm">
                                <div class="login__mainForm-error" style="display: none;">
                                    <span>"Bạn chưa đăng nhập tài khoản!"</span>
                                </div>
                                <!-- <form action="#" method="post" class="login__mainForm-action" name=""> -->
                                <div class="login__mainForm-action">                             
                                    ...
                                    <div class="login__mainForm-action-group">
                                        ...
                                        <input value="<?=$username?>" name="username" type="text" class="login__mainForm-action-group-input">
                                    </div>
                                    <div class="login__mainForm-action-group">
                                        <label for="#">Địa chỉ</label>
                                        <input value="<?=$address?>" name="address" type="text" class="login__mainForm-action-group-input">
                                    </div>
                                    <div class="login__mainForm-action-group">
                                        <label for="#">Email người đặt</label>
                                        <input value="<?=$email?>" name="email" type="email" class="login__mainForm-action-group-input">
                                    </div>
                                    <div class="login__mainForm-action-group">
                                        <label for="#">Số điện thoại</label>
                                        <input value="<?=$phone?>" name="phone" type="tel" class="login__mainForm-action-group-input">
                                    </div>
                                    <!-- <div class="login__mainForm-action-button">
                                        <button name="login" type="submit" class="button button--login login__mainForm-action-button-login">
                                          Đăng nhập
                                        </button>
                                    ...
                                    <div class="login__mainForm-action-group">
                                        <p class="login__mainForm-action-group-text">
                                            <a href="./change-pass.html">Đổi mật khẩu</a>
                ...
                <div class="content row">
                    <div class="l-12">
                        <div class="login__form">
                            <h2 class="login__title">Phương thức thanh toán</h2>
                            <div class="login__mainForm method__pay">
                                <div class="login__mainForm-error" style="display: none;">
                                    <span>"Bạn chưa đăng nhập tài khoản!"</span>
                                </div>
                                <!-- <form action="#" method="post" class="login__mainForm-action" name=""> -->
                                <div class="login__mainForm-action" style="display:flex; justify-content: space-between;">  
                                    <input name="#" type="hidden" class="login__mainForm-action-abc">
                                    <input name="#" type="hidden">
                                    <div class="login__mainForm-action-group">
                                        <label for="#">Thanh toán trực tiếp</label>
                                        <input value="1" checked name="pay" type="radio" class="login__mainForm-action-group-input">
                                    </div>
                                    <div class="login__mainForm-action-group">
                                        <label for="#">Visa</label>
                                        <input value="2" name="pay" type="radio" class="login__mainForm-action-group-input">
                                    </div>
                                    <div class="login__mainForm-action-group">
                                        <label for="#">Mastercard</label>
                                        <input value="3" name="pay" type="radio" class="login__mainForm-action-group-input">
                                    </div>
                                    <div class="login__mainForm-action-group">
                                        <label for="#">ATM</label>
                                        <input value="4" name="pay" type="radio" class="login__mainForm-action-group-input">
                                    </div>
                                <!-- </form> -->
                                </div>
                            </div>
                ...
                <div class="content__body-bottom1" style="background-color: #fff; height: 10rem; display:flex; align-items:center; justify-content:flex-end;">
                    <!-- <form action="" method="post"> -->
                        <div class="row5__checkout" style="margin-right: 1rem;">                    
                           <!-- <a href="index.php?view=cartcomfirm" style="background-color: #005D4F;">
                          </a> -->
                          <input name="cartcomfirm" value="Hoàn tất đặt hàng" type="submit" class="btn__buy btn__dis">
                        </div>
